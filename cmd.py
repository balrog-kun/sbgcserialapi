...
EmergencyStopCode = Enum(Int8ul, # Appending E: "Emergency stop" error codes
    I2C_ERRORS = 1,
    DRV_OTW = 2,
    DRV_FAULT = 3,
    ENCODER_IMU_ANGLE = 4,
    CALIBRATION_FAILED = 5,
    INTERNAL_SYSTEM_ERROR = 6,
    ENCODER_CALIB_BAD_SCALE = 7,
    OVER_TEMPERATURE = 8,
    BAD_MOTOR_POLES_INVERT = 9,
    NOT_ENOUGH_MEMORY = 10,
    IMU_SENSOR_NOT_RESPONDING = 11,
    CAN_HARD = 12,
    MOTOR_OVERHEAT_PROTECTION = 13,
    MOTOR_IS_LOCKED = 14,
    BAD_IMU_HEALTH = 15,
    INFINITE_RESET = 16,
    WRONG_INITIAL_POSITION = 17,
    MOTOR_LOAD_TIME_EXCEEDED = 18,
    CAN_DRV_OVERCURRENT = 19,
    CAN_DRV_UNDERVOLTAGE = 20,
    CAN_DRV_EMERGENCY_PIN = 21,
    CAN_DRV_FOC_DURATION = 22,
    CAN_DRV_MCU_OVERHEAT = 23,
    CAN_DRV_MOTOR_OVERHEAT = 24,
    CAN_DRV_OVERCURRENT_SOFT = 25,
    CAN_DRV_SEVERAL = 26,
    CAN_EXT_BUS_OFF = 27,
    CAN_INT_BUS_OFF = 28,
    ENCODER_NOT_FOUND = 29,
    CAN_DRV_NOT_RESPONDING = 30,
    CAN_DRV_WRONG_PARAMS = 31,
    OVERCURRENT = 32,
    UNSAFE_VOLTAGE = 33,
    WRONG_FULL_BAT_VOLTAGE_PARAM = 34,
    EEPROM_PARAMS_CORRUPTED = 35,
    ENCODER_UNSUPPORTED_TYPE = 36,
    EXT_IMU_UNSUPPORTED_TYPE = 37,
    EXT_IMU_SENSOR_NOT_RESPONDING = 38,
    EXT_IMU_WRONG_PARAMS = 39,
    DRIVER_INIT = 40,
    EEPROM_VARS_OUT_OF_BORDERS = 41,
    IWDG_RESET = 42,
    ADC_WAIT = 43,
    CALIB_MOTOR_OFF = 44,
    TIMEOUT = 45,
    CAN_DRV_CALIB_UNEXPECTED_RES = 46,
    MAG_SENSOR_NOT_RESPONDING = 47,
    CAN_DRV_OVERSPEED = 48,
    ENC_SELF_CALIB_FAILED = 49,
    CAN_VERSION_MISMATCH = 50,
    CAN_SERIAL_INIT = 51,
    CAN_SERIAL_CONFLICT = 52,
    CAN_DRV_INIT_STAGE = 53,
    ENCODER_DATA_TIMEOUT = 54,
    CAN_CONNECTION_LOST = 55,
    HSE_START_FAIL = 56,
    FRAME_IMU_SENSOR_NOT_RESPONDING = 57,
    PARAMETERS_MODIFIED = 58,
    NOT_NORMAL_POSITION = 59,
    CAN_DRV_LIMIT_EXCEED = 60,
)
